// $Id: midi_port.h 1489 2012-07-29 20:40:48Z tk $
/*
 * MIDI Port functions
 *
 * ==========================================================================
...
#define MIDI_PORT_NUM_IN_PORTS  (1 + MIDI_PORT_NUM_IN_PORTS_USB  + MIDI_PORT_NUM_IN_PORTS_UART  + MIDI_PORT_NUM_IN_PORTS_OSC)
#define MIDI_PORT_NUM_OUT_PORTS (1 + MIDI_PORT_NUM_OUT_PORTS_USB + MIDI_PORT_NUM_OUT_PORTS_UART + MIDI_PORT_NUM_OUT_PORTS_OSC)
#define MIDI_PORT_NUM_CLK_PORTS (    MIDI_PORT_NUM_CLK_PORTS_USB + MIDI_PORT_NUM_CLK_PORTS_UART + MIDI_PORT_NUM_CLK_PORTS_OSC)
